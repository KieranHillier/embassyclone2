  ...
  _renderCertifications = () => {
    return certificationIcons.map((link, idx) => (
      <div className="home-certification-icon-container">
        <img
          className="home-certification-icon"
          src={link}
          key={idx}
      ...
      <div>
        <div className="entry-content">
            ...
            <div className="home-body-text">
              <div className="home-body-top-container">
                <div className="home-body-left-container">
                  <h2>
                    Unlimited{' '}
                    <span className="home-body-thin">Possibilities</span>
                  </h2>
                  <p>
                    No matter what you are looking for, with our team of
                    Certified Flavourists, Bakery Specialists, and Food
                    Scientists, Embassy offers a variety of formats and
                    concentrates to meet your product and process requirements.
                  </p>
                </div>
              ...
              {dimensions.width >= mediaQuery.desktop ? (
                <div className="home-body-bottom-container">
                  <div className="home-body-left-container">
                    <div className="home-cl-icons">{this._renderCLIcons()}</div>
                  </div>
                  <div className="home-body-right-container">
                    <h2>
                      Clean-Label{' '}
                      <span className="home-body-thin">Matters</span>
                    </h2>
                    <p>
                      Consumers demand it and we create it! Our quality
                      flavours, bakery mixes, and bases are made from the
                      highest quality ingredients. Our focus is to use
                      ingredients customers can pronounce.
                    </p>
                  </div>
                </div>
              ) : (
          ...
          <div className="home-promise-container">
            <div className="home-promise-text">
              <p>core purpose</p>
              <h2>The secret ingredient behind extraordinary food</h2>
            </div>
          </div>
          <div className="home-body-container">
            <div className="home-body-text">
              <div className="home-body-top-container">
                <div className="home-body-left-container">
                  <h2>
                    Leaders{' '}
                    <span className="home-body-thin">in Market Trends</span>
                  </h2>
                  <p>
                    Innovation is at Embassy’s core. We find inspiration from
                    around the world and develop innovative products before the
                    trend emerges in your mark.
                  </p>
                </div>
                <div className="home-body-right-container">
              ...
              {dimensions.width >= mediaQuery.desktop ? (
                <div className="home-body-bottom-container">
                  ...
                  <div className="home-body-right-container">
                    <h2>
                      Unmatched <span className="home-body-thin">Quality</span>
                    </h2>
                    <p>
                      Our unique approach combines the expertise of Certified
                      Flavourists, Bakery Specialists, and Food Scientists,
                      guaranteeing superior product manufacturing and advanced
